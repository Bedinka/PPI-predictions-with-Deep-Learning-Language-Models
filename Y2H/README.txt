.
common_huri_ddi.csv is the output generated with the python code : huri_ddi.py       (has all the computed matches between both files.)
common_huri_dmi.csv is the output generated with the python code : huri_dmi.py       (has all the computed matches between both files.)
