def open_files():
    original_data = open("./original.txt", "r")
    predicted_data = open("./Train9_pred.txt", "r")
...
if __name__ == "__main__":
    ...
    with open("./Scores/scores.txt", "w") as output_file:
    ...
    print("Comparison scores have been written to 'scores.txt'.")
